...
// The Game class extends JPanel and implements ActionListener and KeyListener interfaces
public class Game extends JPanel implements ActionListener, KeyListener {
	...
	public void setupWindow() {
		...
		JPanel p = new Game(); // Create a new instance of Game
	...
	public static void main(String[] args) {
		Game g = new Game(); // Create a new instance of Game
