...
public class Game extends JPanel implements ActionListener, KeyListener{
	...
	public void paintComponent(Graphics g) {
		...
		int player1Width = player1Image.getWidth(null);
		int player1Height = player1Image.getHeight(null);
		int player1Size = 2;
		
		int player2Width = player2Image.getWidth(null);
		int player2Height = player2Image.getHeight(null);
		int player2Size = 2;
