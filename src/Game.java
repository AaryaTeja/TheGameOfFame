...
public class Game extends JPanel implements ActionListener, KeyListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == gameTM) {
            ...
            for (int i = 0; i < Math.abs(pl1XVel); i++) {
                boolean isPl1Left = isBlockAt(pl1X - (player1Width / player1Size / 2), pl1Y) || isBlockAt(pl1X - (player1Width / player1Size / 2), pl1Y + (player1Height / player1Size)) || isBlockAt(pl1X - (player1Width / player1Size / 2), pl1Y + (player1Height / player1Size / 2));
                boolean isPl1Right = isBlockAt(pl1X + (player1Width / player1Size / 2), pl1Y) || isBlockAt(pl1X + (player1Width / player1Size / 2), pl1Y + (player1Height / player1Size)) || isBlockAt(pl1X + (player1Width / player1Size / 2), pl1Y + (player1Height / player1Size / 2));
                
                if (!isPl1Left && pl1XVel < 0) {
                    pl1X--;
                } else if (!isPl1Left && pl1XVel > 0) {
                    pl1X++;
                }
            }
