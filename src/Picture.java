...
public class Picture {
	...
	public Picture() {
		...
		images.put("crate", new ImageIcon("src/Crate.png").getImage());
		images.put("ghost", new ImageIcon("src/Ghost.png").getImage());
		images.put("pipe", new ImageIcon("src/Pipe.png").getImage());
